...
public class BuscarProductos extends javax.swing.JFrame {
   ...
   agregarItem();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            PreparedStatement pps = cn.prepareStatement("INSERT INTO productos(Nombre, Precio, Vencimiento, Descripcion, Laboratorio, Cantidad) VALUES (?,?,?,?,?,?)");
            pps.setString(1, txtNombre.getText());
            pps.setString(2, txtPrecio.getText());
            pps.setString(3, txtVencimiento.getText());
            pps.setString(4, txtDescripcion.getText());
            pps.setString(5, txtLaboratorio.getText());
            pps.setString(6, txtCantidad.getText());
            pps.executeUpdate();
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        try {
            PreparedStatement pps = cn.prepareStatement("UPDATE productos SET Nombre='"+txtNombre.getText()+"',Precio='"+txtPrecio.getText()+"',Vencimiento='"
